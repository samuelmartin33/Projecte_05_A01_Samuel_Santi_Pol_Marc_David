...
var PRECIO_BASE  = {{ $evento->precio_base ?? 0 }};
var ES_GRATUITO  = {{ $evento->es_gratuito ? 'true' : 'false' }};
var AFORO_LIBRE  = {{ $evento->aforo_maximo ? $evento->aforo_maximo - $evento->aforo_actual : 9999 }};
