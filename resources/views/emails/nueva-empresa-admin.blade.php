...
<div class="wrapper">
    ...
    <div class="body">
        ...
        <div class="data-box">
            <table>
                <tr>
                    ...
                    <td class="valor"><strong>{{ $empresa->nombre_empresa }}</strong></td>
                </tr>
                @if($empresa->razon_social)
                <tr>
                    <td class="label">Razón social</td>
                    <td class="valor">{{ $empresa->razon_social }}</td>
                </tr>
                @endif
                <tr>
                    <td class="label">NIF / CIF</td>
                    <td class="valor">{{ $empresa->nif_cif ?? '—' }}</td>
                </tr>
                <tr>
                    <td class="label">Tipo</td>
                    <td class="valor">{{ ucfirst(str_replace('_', ' ', $empresa->tipo_promotor ?? '—')) }}</td>
                </tr>
                <tr>
                    <td class="label">Representante</td>
                    <td class="valor">{{ $usuario->nombre }} {{ $usuario->apellido1 }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="valor">{{ $usuario->telefono }}</td>
                </tr>
                @endif
                <tr>
                    <td class="label">Registrada</td>
                    <td class="valor">{{ \Carbon\Carbon::parse($usuario->fecha_creacion)->format('d/m/Y \a \l\a\s H:i') }}</td>
                </tr>
            </table>
        </div>
        ...
        <div class="btn-wrapper">
            <a href="{{ url('/admin/empresas') }}" class="btn">Revisar solicitud en el panel →</a>
        </div>
    </div>
