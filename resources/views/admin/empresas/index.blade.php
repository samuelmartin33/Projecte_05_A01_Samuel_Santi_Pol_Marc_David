                        ...
                        @foreach ($pendientes as $empresa)
                            <tr>
                                ...
                                <td data-label="Acciones" class="actions-cell">
                                    ...
                                    <form method="POST" action="{{ route('admin.empresas.aprobar', $empresa->id) }}" style="display:inline;" class="js-confirm-empresa" data-action-label="aprobar" data-empresa="{{ $empresa->nombre }} {{ $empresa->apellido1 }}">
                                        @csrf
                                        <button type="submit" class="btn btn-success btn-sm">
                                            Aprobar
                                        </button>
                                    </form>
                                    <form method="POST" action="{{ route('admin.empresas.rechazar', $empresa->id) }}" style="display:inline;" class="js-confirm-empresa" data-action-label="rechazar" data-empresa="{{ $empresa->nombre }} {{ $empresa->apellido1 }}">
                                        @csrf
