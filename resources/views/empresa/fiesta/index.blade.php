        ...
        <form id="form-evento" enctype="multipart/form-data">
            ...
            <div class="dos-col">
                <div class="campo-grupo">
                    <label>
                        Precio entrada (€) *
                        <small class="aviso-camarero">Fiesta siempre de pago</small>
                    </label>
                    <input type="number" name="precio_base" id="campo-precio" step="0.01" min="0.01" required>
                </div>
                <div class="campo-grupo">
            ...
            <div class="campo-grupo">
                <label>
                    Camarero asignado *
                    <small class="aviso-camarero">Obligatorio para eventos Fiesta</small>
                </label>
                ...
                @if($camareros->isEmpty())
                    <p class="aviso-camarero">
                        ⚠ No tienes camareros contratados. Publica una oferta con categoría Camarero/a primero.
                    </p>
                @endif
            </div>
