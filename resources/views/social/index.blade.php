...
{{-- ============================================================
     PÁGINA SOCIAL
     Estructura de dos paneles: barra lateral izquierda + área de chat derecha.
     En móvil: panel lateral ocupa toda la pantalla hasta que se abre un chat.
     ============================================================ --}}
<div class="social-pagina" id="social-pagina">

    {{-- ── Panel izquierdo: navegación y listas ── --}}
    ...
    <section class="social-chat-area" id="area-chat">
        ...
        <div class="social-chat-ventana" id="chat-ventana" style="display:none">
            ...
            <div class="social-chat-cabecera" id="chat-cabecera">
                ...
                {{-- Info del amigo (inyectada por JS) --}}
                <div id="chat-amigo-info" class="chat-amigo-info"></div>
            </div>

            {{-- Área desplazable de mensajes --}}
...
@section('scripts')
<script>
    {{-- Pasar el ID del usuario autenticado al JS --}}
