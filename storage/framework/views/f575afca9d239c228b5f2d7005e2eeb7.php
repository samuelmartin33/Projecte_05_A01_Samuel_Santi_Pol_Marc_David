<section class="card" id="eventos-listado">
...
<?php if($eventos->hasPages()): ?>
    <nav class="paginacion" aria-label="Paginacion de eventos">
        ...
        <div class="pagination-controls">
            ...
            <?php else: ?>
                <a class="pagination-arrow js-pagination-link" href="<?php echo e($eventos->previousPageUrl()); ?>" rel="prev" aria-label="Pagina anterior">‹</a>
            <?php endif; ?>
            ...
            <?php for($page = 1; $page <= $eventos->lastPage(); $page++): ?>
                ...
                <?php else: ?>
                    <a class="pagination-page js-pagination-link" href="<?php echo e($eventos->url($page)); ?>" aria-label="Ir a la pagina <?php echo e($page); ?>"><?php echo e($page); ?></a>
                <?php endif; ?>
            <?php endfor; ?>

            <?php if($eventos->hasMorePages()): ?>
                <a class="pagination-arrow js-pagination-link" href="<?php echo e($eventos->nextPageUrl()); ?>" rel="next" aria-label="Pagina siguiente">›</a>
            <?php else: ?>
                <span class="pagination-arrow disabled" aria-hidden="true">›</span>
            <?php endif; ?>
        </div>
    </nav>
<?php endif; ?><?php /**PATH C:\wamp64\www\DAW2\0616\Projecte_05_A01_Samuel_Santi_Pol_Marc_David\resources\views/admin/eventos/_list.blade.php ENDPATH**/ ?>