            ...
            <form id="registerForm" novalidate autocomplete="off" onsubmit="registrar(event)">
                <div class="auth-form">
                    ...
                    <label class="auth-check auth-check-tall">
                        ...
                        <span>Acepto los <a href="<?php echo e(route('terminos')); ?>">Términos de uso</a> y la <a href="<?php echo e(route('privacidad')); ?>">Política de privacidad</a>. Soy mayor de 16 años.</span>
                    </label>
