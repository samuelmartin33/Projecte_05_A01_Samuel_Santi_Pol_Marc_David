<?php $__env->startSection('titulo', 'Política de devoluciones — VIBEZ'); ?>
...
<div style="max-width:780px;margin:80px auto;padding:0 32px;">
  ...
  <div style="font-family:'Archivo Narrow',sans-serif;font-size:16px;color:var(--ink-dim);line-height:1.75;">
    ...
    <div style="margin-bottom:24px;padding:20px;border:1px solid var(--line);">
      ...
      <p style="margin:0;font-size:14px;"><?php echo e($texto); ?></p>
    </div>
  ...
  <a href="<?php echo e(route('home')); ?>" style="display:inline-flex;align-items:center;gap:8px;color:var(--magenta);font-family:'Archivo Narrow',sans-serif;font-size:13px;text-transform:uppercase;letter-spacing:0.1em;text-decoration:none;border-bottom:1px solid var(--magenta);padding-bottom:2px;margin-top:40px;">
    ← Volver al inicio
  </a>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\DAW2\proyectos\Projecte_05_A01_Samuel_Santi_Pol_Marc_David\resources\views/static/devoluciones.blade.php ENDPATH**/ ?>