...
async function _fetchLista(url) {
    ...
    try {
        ...
        const nueva = doc.getElementById('candidaturas-lista');
        if (nueva) {
...
// Paginación via AJAX (delegación de eventos sobre el contenedor estático)
...
// ── Cerrar / reabrir oferta ──────────────────────────────────────────────────
async function toggleOferta() {
    const btn = document.getElementById('btn-cerrar-oferta');
    btn.disabled = true;
    ...
    try {
        ...
        // Actualizar el indicador de estado en el hero
        const estadoSpan = document.getElementById('oferta-estado-badge');
        if (estadoSpan) {
