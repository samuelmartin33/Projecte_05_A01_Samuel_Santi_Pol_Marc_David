...
<div class="soc" id="soc">
    ...
    <div class="soc-panel" id="panel-amigos">
        ...
        <header class="soc-topbar">
            ...
            <div class="soc-topbar-acciones">
                
                <button class="soc-topbar-btn" onclick="abrirModalCrew()" title="Crear crew">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="soc-modal-overlay" id="modal-crew-overlay" style="display:none"
         onclick="cerrarModalCrew()">
        <div class="soc-modal" onclick="event.stopPropagation()">

            <div class="soc-modal-head">
                <h3 class="soc-modal-titulo">Crear crew</h3>
                <button class="soc-modal-cerrar" onclick="cerrarModalCrew()">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12"/>
                    </svg>
                </button>
            ...
            <div class="soc-modal-body">
                ...
                <input type="text" id="crew-input-nombre" class="soc-input"
                       placeholder="Ej: Crew del festival, Gang vibes…"
                       maxlength="50">

                <label class="soc-field-label" style="margin-top:16px">
                    Añadir amigos * (mínimo 1)
                </label>
                <div id="crew-lista-amigos" class="crew-amigos-lista">
                    <p class="soc-vacio-small">Cargando amigos…</p>
                </div>
            </div>

            <div class="soc-modal-foot">
                <button class="soc-btn-secondary" onclick="cerrarModalCrew()">Cancelar</button>
